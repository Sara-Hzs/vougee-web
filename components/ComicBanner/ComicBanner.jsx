    ...
    return (
        <div className="ComicBanner">
            ...
            <svg className="curvy" width="100%" height="80%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 80" preserveAspectRatio="none">
                ...
                <path d="M0,2 L2,2 C10,3 8,10 23,11 L110,11 L177,11 C192,10 190,3 198,2 L200,2 V30 H0 Z" fill="#455725" />
                <path d="M0,2 L2,2 C10,3 8,10 23,11 L110,11 L177,11 C192,10 190,3 198,2 L200,2" stroke="#455725" strokeWidth="1" fill="none" />
            </svg>
        </div>
    );
}